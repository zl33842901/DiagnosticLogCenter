...
namespace xLiAd.DiagnosticLogCenter.UserInterfaceByEs.Services
{
    public class LogReadService : ILogReadService
    {
        ...
        public async Task<(TongJiResult, TongJiInterfaceResult, TongJiInterfaceResult, TongJiInterfaceResult)> GetTongJi(Models.ICliEnvDate cliEnv)
        {
            var ie = await logRepository.GetAllData(cliEnv);
    ...
    public interface ILogReadService
    {
        ...
        Task<(TongJiResult, TongJiInterfaceResult, TongJiInterfaceResult, TongJiInterfaceResult)> GetTongJi(Models.ICliEnvDate cliEnv);
